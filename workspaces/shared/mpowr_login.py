"""
mpowr_login.py — Canonical MPOWR Authentication Module

Single source of truth for the MPOWR login flow used by ALL agents:
  - MPWR Reservation Agent (Creator Bot)
  - MPWR Update/Cancel Agent
  - MPWR Payment Agent
  - Waiver Recon Agent (via mpowr_browser.py)

If Polaris changes their login UI, fix it HERE — all agents update automatically.
"""
